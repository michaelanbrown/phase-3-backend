...
Property.create(street_address: "118 Mercy Circle", city: "Hardeeville", state: "SC", purchase_price: nil, square_feet: 35800, garage_spaces: 0, link: "https://www.loopnet.com/Listing/118-Mercy-Cir-Hardeeville-SC/27699142/", type: Type.find_by(property_type: "Apartment Building"), flip_status: nil)
Property.create(street_address: "35 Heritage Rd", city: "Signal Mountain", state: "TN", purchase_price: nil, square_feet: 3530, garage_spaces: 0, link: "https://www.realtor.com/realestateandhomes-detail/35-Heritage-Rd_Signal-Mountain_TN_37377_M82005-37933", type: Type.find_by(property_type: "Multifamily"), flip_status: nil)
Property.create(street_address: "4396 Amnicola Hwy", city: "Chattanooga", state: "TN", purchase_price: nil, square_feet: 5464, garage_spaces: nil, link: "https://www.loopnet.com/Listing/4396-Amnicola-Chattanooga-TN/27742332/", type: Type.find_by(property_type: "Commercial/Business"), flip_status: nil)
